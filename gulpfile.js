...
gulp.task('lint', () => gulp.src(['app/scripts/*.js', '!app/scripts/bootstrap.min.js', '!app/scripts/jquery.min.js', '!node_modules', '!gulpfile.js', '!app/scripts/photographer-page/simple-lightbox.js'])
  .pipe(eslint())
  .pipe(eslint.format()));
